#!/bin/bash
# ============================================
# AMOKHAN TECH DNSTT AUTO INSTALL (INTERACTIVE TDOMAIN)
...
# CONFIG (Interactive)
############################
read -p "Enter your TDOMAIN (e.g., ns-ex.elitex.sbs): " TDOMAIN
MTU=1800
DNSTT_PORT=5300
DNS_PORT=53
############################

echo "==> AMOKHAN TECH DNSTT AUTO INSTALL STARTING..."

# Root check
if [ "$(id -u)" -ne 0 ]; then
  echo "[-] Run as root: sudo bash amokhan-tech-dnstt-auto.sh"
  exit 1
fi

# Stop conflicting services
echo "==> Stopping old services..."
for svc in dnstt dnstt-server slowdns dnstt-smart dnstt-amokhan-tech dnstt-amokhan-tech-proxy; do
...
# DNSTT service
echo "==> Creating dnstt-amokhan-tech.service..."
cat >/etc/systemd/system/dnstt-amokhan-tech.service <<EOF
[Unit]
Description=AMOKHAN TECH DNSTT Server
...
# Proxy service
echo "==> Creating dnstt-amokhan-tech-proxy.service..."
cat >/etc/systemd/system/dnstt-amokhan-tech-proxy.service <<EOF
[Unit]
Description=AMOKHAN TECH DNSTT EDNS Proxy
After=network-online.target dnstt-amokhan-tech.service
...
systemctl enable dnstt-amokhan-tech.service
systemctl enable dnstt-amokhan-tech-proxy.service
systemctl start dnstt-amokhan-tech.service
systemctl start dnstt-amokhan-tech-proxy.service

echo "======================================"
echo " AMOKHAN TECH DNSTT INSTALLED SUCCESSFULLY "
echo "======================================"
echo "DOMAIN  : ${TDOMAIN}"
echo "MTU     : ${MTU}"
echo "PUBLIC KEY:"
